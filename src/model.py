...
class TimeSeriesProcessor:
    ...
    def _save_basic_results(self, result: pd.DataFrame, file_prefix: str) -> None:
        ...
        features_filename = os.path.join(self.output_dir, f"DATA_characteristics_{file_prefix}.csv")
    ...
    def _save_mean_results(self, mean_result: pd.DataFrame, file_prefix: str) -> None:
        ...
        mean_features_filename = os.path.join(self.output_dir, f"mean_DATA_characteristics_{file_prefix}.csv")
